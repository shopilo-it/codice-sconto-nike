#!/usr/bin/env python3
"""
Recupero codici sconto Nike da shopilo.it
Sursa: https://shopilo.it/negozi/nike.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/nike.com"
STORE_NAME = "Nike"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Nike da shopilo.it"""
    headers = {
