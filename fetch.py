#!/usr/bin/env python3
"""
Fetch coduri de reducere Nike de pe shopilo.it
Sursa: https://shopilo.it/magazin/nike.com
"""
...
SHOPILO_URL = "https://shopilo.it/magazin/nike.com"
STORE_NAME = "Nike"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Nike de pe shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-nike)"
    }
    try:
