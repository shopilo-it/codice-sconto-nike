#!/usr/bin/env node
/**
 * Fetch coduri reducere Nike de pe shopilo.it
 * Homepage: https://shopilo.it/magazin/nike.com
 */

const SHOPILO_URL = "https://shopilo.it/magazin/nike.com";
const STORE_NAME  = "Nike";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-nike)" }
  });
